...
class Places365:
    ...
    def __init__(self,
                 ...
                 seed=0,
                 **kwargs):
        location = os.path.join(location, 'places365')
        # self.train_dataset = torchvision.datasets.Places365(root=location, split='train-standard',
        #                                                      small=True, transform=preprocess)
        # self.val_dataset = torchvision.datasets.Places365(root=location, split='val', small=True,
        #                                                   transform=preprocess)

        self.train_dataset = None
        self.val_dataset = None
        self.test_dataset = torchvision.datasets.Places365(root=location, split='val', small=True,
                                                           transform=preprocess)
